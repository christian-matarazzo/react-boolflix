export default function AppHome({search, setSearch, handleSearch}) {
    return (
        ...
        <input type="text" value={search} onChange={setSearch} placeholder="Cosa cerchiamo?..." className="input-field mx-3 my-5"></input> <button onClick={handleSearch} className="btn btn-danger">Cerca</button>
        </div>
        </main>
    )
}